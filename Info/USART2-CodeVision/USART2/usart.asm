...
_0x0:
	.DB  0x20,0x74,0x65,0x73,0x74,0x20,0x2D,0x20
	.DB  0x4F,0x4B,0x20,0x0
_0x20012:
...
; 0001 0070     sym = usartRxBuf[rxBufHead];        //прочитать из него символ
	MOV  R30,R9
	LDI  R31,0
	SUBI R30,LOW(-_usartRxBuf)
	SBCI R31,HIGH(-_usartRxBuf)
	LD   R17,Z
...
; 0001 007E       usartRxBuf[rxBufTail] = UDR;        //считать символ из UDR в буфер
	MOV  R26,R6
	LDI  R27,0
	SUBI R26,LOW(-_usartRxBuf)
	SBCI R27,HIGH(-_usartRxBuf)
	IN   R30,0xC
	ST   X,R30
...
SUBOPT_0x0:
	LDI  R31,0
	SUBI R30,LOW(-_usartTxBuf)
	SBCI R31,HIGH(-_usartTxBuf)
	RET
