...
namespace AvrUsbDevice
{
    unsafe class ATMega16
    {
        ...
        */
        ...
        public const byte aICR1L    = 0x26;
        public const byte aICR1H    = 0x27;

        public const byte aOCR1BL   = 0x28;
        public const byte aOCR1BH   = 0x29;

        public const byte aOCR1AL   = 0x2A;
        public const byte aOCR1AH   = 0x2B;

        public const byte aTCNT1L   = 0x2C;
        public const byte aTCNT1H   = 0x2D;

        public const byte aTCCR1B   = 0x2E;
        public const byte CS10      = 0;
        public const byte CS11      = 1;
        public const byte CS12      = 2;
        public const byte WGM12     = 3;
        public const byte WGM13     = 4;
        public const byte ICES1     = 6;
        public const byte ICNC1     = 7;

        public const byte aTCCR1A   = 0x2F;
        public const byte WGM10     = 0;
        public const byte WGM11     = 1;
        public const byte FOC1B     = 2;
        public const byte FOC1A     = 3;
        public const byte COM1B0    = 4;
        public const byte COM1B1    = 5;
        public const byte COM1A0    = 6;
        public const byte COM1A1    = 7;
        #endregion
        ...
        #region Работа с таймером TIMER1
        public byte ICR1L
        {
            set
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aICR1L, null, 0, 5000);
            }
        }
        ...
        public byte ICR1H
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aICR1H, null, 0, 5000);
            }
        }
        ...
        public byte OCR1BL
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aOCR1BL, null, 0, 5000);
            }
        }
        ...
        public byte OCR1BH
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aOCR1BH, null, 0, 5000);
            }
        }
        ...
        public byte OCR1AL
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aOCR1AL, null, 0, 5000);
            }
        }
        ...
        public byte OCR1AH
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aOCR1AH, null, 0, 5000);
            }
        }
        ...
        public byte TCNT1L
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aTCNT1L, null, 0, 5000);
            }
        }
        ...
        public byte TCNT1H
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aTCNT1H, null, 0, 5000);
            }
        }
        ...
        public byte TCCR1B
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aTCCR1B, null, 0, 5000);
            }
        }
        ...
        public byte TCCR1A
        {
            ...
            {
                usb_control_msg(handle, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_ENDPOINT_OUT,
                                RQ_IO_WRITE, value, aTCCR1A, null, 0, 5000);
            }
        }
